    ...
    public class UnitTestHelper
    {
        ...
        public static List<RoomDto> RoomsDto
        {
            get
            {
                ...
                {
                    new RoomDto { Id = "1", Category = RoomCategory.Standart, VisitorsNumber = 2, Description = "Standart room in hotel", Price = 800, imgName="Main-Standart-1" },
                    new RoomDto { Id = "2", Category = RoomCategory.Superior, VisitorsNumber = 3, Description = "Superior room in hotel", Price = 1200, imgName="Main-Superior-1" },
                    new RoomDto { Id = "3", Category = RoomCategory.Apartment, VisitorsNumber = 4, Description = "Apartment room in hotel", Price = 1700, imgName = "Main-Apartment-1" },
                    new RoomDto { Id = "4", Category = RoomCategory.Lux, VisitorsNumber = 3, Description = "Lux room in hotel", Price = 2000, imgName = "Main-Lux-1" },
                    new RoomDto { Id = "5", Category = RoomCategory.Duplex, VisitorsNumber = 6, Description = "Duplex room in hotel", Price = 2500, imgName = "Main-Duplex-1" }
                };
            }
        }
        ...
        public static List<BookDto> BooksDto
        {
            get
            {
                ...
                {
                    new BookDto { Id = "1", Price = 700, StartDate = new DateTime(2020, 8, 15), EndDate = new DateTime(2020, 8, 20), CustomerId = "1", RoomId = "1" },
                    new BookDto { Id = "2", Price = 800, StartDate = new DateTime(2020, 8, 25), EndDate = new DateTime(2020, 8, 28), CustomerId = "2", RoomId = "1" },

                    new BookDto { Id = "3", Price = 1300, StartDate = new DateTime(2020, 9, 1), EndDate = new DateTime(2020, 9, 6), CustomerId = "1", RoomId = "2" },
                    new BookDto { Id = "4", Price = 1200, StartDate = new DateTime(2020, 9, 7), EndDate = new DateTime(2020, 9, 12), CustomerId = "2", RoomId = "2" },

                    new BookDto { Id = "5", Price = 1500, StartDate = new DateTime(2020, 9, 15), EndDate = new DateTime(2020, 9, 17), CustomerId = "2", RoomId = "3" },
                    new BookDto { Id = "6", Price = 1600, StartDate = new DateTime(2020, 9, 18), EndDate = new DateTime(2020, 9, 25), CustomerId = "3", RoomId = "3" },

                    new BookDto { Id = "7", Price = 2100, StartDate = new DateTime(2020, 9, 26), EndDate = new DateTime(2020, 9, 28), CustomerId = "2", RoomId = "4" },
                    new BookDto { Id = "8", Price = 1900, StartDate = new DateTime(2020, 10, 2), EndDate = new DateTime(2020, 10, 7), CustomerId = "3", RoomId = "4" },

                    new BookDto { Id = "9", Price = 2300, StartDate = new DateTime(2023, 02, 16), EndDate = new DateTime(2023, 03, 25), CustomerId = "4", RoomId = "5" },
                    new BookDto { Id = "10", Price = 2400, StartDate = new DateTime(2023, 06, 1), EndDate = new DateTime(2023, 07, 2), CustomerId = "4", RoomId = "5" }
        ...
        public static List<Book> BooksViaBookInfoModels
        {
            get
            {
                ...
                {
                    new Book{Id = "1", CustomerId = "1", StartDate = new DateTime(2020, 8, 15), EndDate = new DateTime(2020, 8, 20), RoomId = "1", Price = 800},
